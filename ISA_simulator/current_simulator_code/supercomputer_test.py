...
def main(savename = None, filename = None, node_number = 4,qubit_number = 2, photon_detection_prob = 1, printstates = False, storedata = None,node_distance = 4e-3, photo_distance = 2e-3, noiseless = False, detuning = 0, electron_T2 = 0, electron_T1 = 0, carbon_T1 = 0, carbon_T2 = 0, single_instruction = True, B_osc = 400e-6,no_z_precission = 1, frame = "rotating", wait_detuning = 0, clk = 0, clk_local = 0,B_z = 40e-3,rotation_with_pi = 0,Fault_tolerance_check = False, **kwargs):
	...
	if sys.argv[1] == "supercomputer":
		kwargs["input_state"] = kwargs["kwargs"]["input_state"]
		carbon_T2 = kwargs["kwargs"]["carbon_decoherence"]
		electron_T2 = kwargs["kwargs"]["electron_decoherence"]
	# print(f"the kwargs secondly are {kwargs}")
	if "seed" in kwargs:
		if kwargs["seed"] == True:
			noiseless = True
...
# 
		...
		filename = 'logical_X_gate_fidelity.txt'
		filename = 'logical_X_gate_fidelity_insert.txt'
		# filename = 'physical_X_gate_fidelity_insert.txt'

		# filename = 'logical_X_gate_fidelity_insert_differentCZ.txt'
	...
	if filename == "server_test.txt":
		...
		print(lines)
	elif filename == 'logical_X_gate_fidelity_insert.txt' or filename == 'logical_X_gate_fidelity_insert_differentCZ.txt':
		if kwargs["input_state"] == "p_1":
			lines.insert(23,'QgateUC q0 2 1.57079632679 3.14159265 0')
			lines.insert(24,'QgateUC q0 3 1.57079632679 3.14159265 0')
			if noiseless == True:
				data_stored_name = 'process_tomography_p1_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_p1_X_noisefull_'+str(carbon_T2)

		elif kwargs["input_state"] == "p_plus":
			lines.insert(23,'QgateUC q0 2 1.57079632679 1.57079632679 0')
			lines.insert(24,'QgateUC q0 3 1.57079632679 1.57079632679 0')
			# lines.insert(25,'qgatez q0 4 3.14159265')

			if noiseless == True:
				data_stored_name = 'process_tomography_pplus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_pplus_X_noisefull_'+str(carbon_T2)
		elif kwargs["input_state"] == "p_minus":
			lines.insert(23,'QgateUC q0 2 1.57079632679 1.57079632679 0')
			lines.insert(24,'QgateUC q0 3 1.57079632679 1.57079632679 0')
			lines.insert(25,'qgatez q0 4 3.14159265')
			if noiseless == True:
				data_stored_name = 'process_tomography_pminus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_pminus_X_noisefull_'+str(carbon_T2)
		elif kwargs["input_state"] == "p_i_plus":
			lines.insert(23,'QgateUC q0 2 1.57079632679 1.57079632679 0')
			lines.insert(24,'QgateUC q0 3 1.57079632679 1.57079632679 0')
			lines.insert(25,'qgatez q0 4 1.57079632679')
			if noiseless == True:
				data_stored_name = 'process_tomography_piplus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_piplus_X_noisefull_'+str(carbon_T2)
		elif kwargs["input_state"] == "p_i_minus":
			lines.insert(23,'QgateUC q0 2 1.57079632679 1.57079632679 0')
			lines.insert(24,'QgateUC q0 3 1.57079632679 1.57079632679 0')
			lines.insert(25,'qgatez q0 4 -1.57079632679')
			if noiseless == True:
				data_stored_name = 'process_tomography_piminus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_piminus_X_noisefull_'+str(carbon_T2)
		else:
			if noiseless == True:
				data_stored_name = 'process_tomography_p0_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_p0_X_noisefull_'+str(carbon_T2)
		# print(lines)
		data_stored_name = data_stored_name+"_newest_with_electron_dec"+str(electron_T2)
	elif filename == 'physical_X_gate_fidelity_insert.txt':
		if kwargs["input_state"] == "p_1":
			lines.insert(9,'QgateUC q0 0 1.57079632679 3.14159265 0')
			if noiseless == True:
				data_stored_name = 'process_tomography_p1_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_p1_X_noisefull_'+str(carbon_T2)
			...
			lines.insert(9,'QgateUC q0 0 1.57079632679 1.57079632679 0')
			# lines.insert(25,'qgatez q0 4 3.14159265')
			...
			lines.insert(9,'QgateUC q0 0 1.57079632679 1.57079632679 0')
			lines.insert(10,'qgatez q0 1 3.14159265')
			if noiseless == True:
				data_stored_name = 'process_tomography_pminus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_pminus_X_noisefull_'+str(carbon_T2)
			...
			lines.insert(9,'QgateUC q0 0 1.57079632679 1.57079632679 0')
			lines.insert(10,'qgatez q0 1 1.57079632679')
			if noiseless == True:
				data_stored_name = 'process_tomography_piplus_X_noiseless_'+str(carbon_T2)
			else:
				data_stored_name = 'process_tomography_piplus_X_noisefull_'+str(carbon_T2)
			...
			if noiseless == True:
				...
				data_stored_name = 'process_tomography_p0_X_noisefull_'+str(carbon_T2)
		# print(lines)
		data_stored_name = data_stored_name+"_newest_with_electron_dec"+str(electron_T2)+"physical"
	if sys.argv[1] == "supercomputer":
		if filename == 'logical_hadamard_gate_fidelity.txt' or filename == 'logical_X_gate_fidelity_insert.txt' or filename == 'physical_X_gate_fidelity_insert.txt':
	...
	# print(f"the carbon value is {carbon_T2}")
	# print(f"the electron value is {electron_T2}")
	...
	if (line_reader[-2].split()[0].lower() == "DataStorageName".lower() and data_stored_name == None):
...
def run_multiprocess(
   ...
   #         code.random_errors(**error_rates) #Applying random errors on the current code
	...
	if "DataStorageName" in outputs[0]["values"]:
	# if outputs[0]["values"].has_key("DataStorageName"):
		output["DataStorageName"] = outputs[0]["values"]["DataStorageName"]
	# output[]
	# if benchmark:
...
def main_runner(carbon_T2 = 0,electron_T2 = 0, kwargs = None, noiseless = None):
	start_time = time.perf_counter()
	# print(f"the value of noiseless is {noiseless}")
	# if len(sys.argv) == 1 or noiseless == False:
	if sys.argv[1] == "local":
		if noiseless == False:


			# results = main(node_number = 2,qubit_number=3, printstates=True, detuning = 1e3, electron_T2= 5e3, carbon_T2 = 5e6 ,single_instruction = False, no_z_precission=1,B_osc = 400e-6, frame = "rotating", wait_detuning=0, clk = 0, clk_local = 10e6, **kwargs)
			results = main(electron_T2= electron_T2,carbon_T2 = carbon_T2,**kwargs)
			...
			# if results.has_key("DataStorageName"):
				...
				print(f"storing the data in {storagename}.json")
				data_storer(results,storagename+".json")
		# elif sys.argv[1] == "noiseless" or noiseless == True:
		elif noiseless == True:

			# results = main(node_number = 2,qubit_number=5, printstates=True, detuning = 0, electron_T2= 5e3, carbon_T2 = 56e6 ,single_instruction = True, no_z_precission=1,B_osc = 400e-6, frame = "rotating", wait_detuning=0, clk = 0, clk_local = 0,B_z = 0.1890,rotation_with_pi = 0,noiseless = True, **kwargs)
			# print(f"noiseless is {noiseless}")
			results = main(carbon_T2 = 0,noiseless = True, **kwargs)
		...
		# QISA_file = ["physical_X_gate_fidelity_insert.txt"]
		QISA_file = ["logical_X_gate_fidelity_insert.txt"]

		results = run_multiprocess(iterations=iterations,QISA_file = QISA_file, noiseless = noiseless_arg, kwargs = kwargs)
		end_time = time.perf_counter()-start_time
		results["time_duration"] = end_time
		if "DataStorageName" in results:
		# if results.has_key("DataStorageName"):
			storagename = str(results.pop("DataStorageName"))
			print(f"storing the data in {storagename}_supercomputer.json")
			data_storer(results,storagename+"_supercomputer.json")
		else:
...
if __name__ == "__main__":
	...
	kwarg_list = ["p_0","p_1","p_plus","p_minus","p_i_plus","p_i_minus"]
	carbon_T2 = 801000.0
	electron_T2 = 100.0
	decoherence_list_carbon = np.arange(1e3,1.2e6,1e5)
	# decoherence_list_carbon = [1001000.0]
	decoherence_list_electron = np.arange(1e2,5e3,5e2)
	decoherence_list_electron = [5100.0]

	# main_runner(noiseless = True, kwargs = {"input_state":kwarg_list[1]})
	# for deco_values_electron in decoherence_list_electron:
	# 	electron_T2 = deco_values_electron
	# 	for deco_values_carbon in decoherence_list_carbon:
	# 		carbon_T2 = deco_values_carbon
	# 		for items in kwarg_list:
	# 			if sys.argv[1] == "local":
	# 				kwargs = {"input_state":items}
	# 			elif sys.argv[1] == "supercomputer":
	# 				kwargs = {"input_state":items,"carbon_decoherence":carbon_T2,"electron_decoherence":electron_T2}
	# 			print(f"the carbon value is {carbon_T2}")
	# 			print(f"the electron value is {electron_T2}")
				
				
	# 			# kwargs = {"input_state":kwarg_list[3]}
	# 			# main_runner(noiseless = True, kwargs = kwargs)
	# 			main_runner(noiseless = False, kwargs = kwargs, carbon_T2 = carbon_T2,electron_T2 = electron_T2)
	# 			print(f"done with state {items}")
	# 			print("")
	# for items in kwarg_list:
	# if sys.argv[1] == "local":
	# 	kwargs = {"input_state":items}
	# elif sys.argv[1] == "supercomputer":
	kwargs = {"input_state":"p_1","carbon_decoherence":carbon_T2,"electron_decoherence":electron_T2}
	main_runner(noiseless = False, kwargs = kwargs, carbon_T2 = carbon_T2,electron_T2 = electron_T2)

		# kwargs = {"input_state":kwarg_list[3]}
		# main_runner(noiseless = True, kwargs = kwargs)
	# kwargs = {"input_state":kwarg_list[0]}
